(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".directions__slider", {
                    ...
                    mousewheel: {
                        sensitivity: true,
                        eventsTarget: ".directions__slider"
                    },
                    navigation: {
                        prevEl: ".swiper-button-prev",
                        nextEl: ".swiper-button-next"
                ...
                new core(".team-company__slider", {
                    ...
                    mousewheel: {
                        sensitivity: true,
                        eventsTarget: ".team-company__slider"
                    },
                    navigation: {
                        prevEl: ".swiper-button-prev",
                        nextEl: ".swiper-button-next"
        ...
        function loadingPage() {
            ...
            let parrent = document.querySelector(".timetable__navigation");
            for (let child of parrent.children) if (child.classList.contains("_tab-active")) child.classList.remove("_tab-active");
            if (0 == dates) parrent.children[6].classList.add("_tab-active"); else parrent.children[dates - 1].classList.add("_tab-active");
        }
        loadingPage();
        window.addEventListener("load", (function() {
            setTimeout((function() {
                let phoneBtn = document.querySelector(".menu__phone-link");
                let vk = document.querySelector(".social__link_vk");
                let screenWidth = window.screen.width;
                if (screenWidth >= 991.98) {
                    phoneBtn.removeAttribute("href");
                    phoneBtn.setAttribute("data-goto", ".footer");
                    vk.innerHTML += "@forwardvolzhsk";
                } else if (screenWidth < 991.98) phoneBtn.removeAttribute("data-goto");
            }), 0);
        }));
        window["FLS"] = true;
        menuInit();
